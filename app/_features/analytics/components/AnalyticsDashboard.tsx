...
import { SimplePromoAnalytics } from "./SimplePromoAnalytics";
    ...
    <div className="p-8 space-y-6">
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          ...
          <TabsTrigger value="promo-codes">Promo Code Analytics</TabsTrigger>
        </TabsList>
              ...
              <div className="flex gap-2">
                {["week", "month", "year"].map((tf) => (
                  <button
                    key={tf}
                    onClick={() =>
                      setTimeframe(tf as "week" | "month" | "year")
                    }
        ...
        <TabsContent value="promo-codes" className="space-y-6">
          <SimplePromoAnalytics promoCodeAnalytics={data.promoCodeAnalytics} />
        </TabsContent>
      </Tabs>
    </div>
  );
